        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            switch (s2)
            {
                ...
                case "add":
                    ...
                    next.setIdetudiant("mail1");
                    next.setPassword("password");
                    next.setMail1("mail1");
                    next.setMail2("mail2");
                    next.setMobile_phone("mobile_phone");
                    next.setDate_naissance("date_naissance");
                    next.setNationalite("nationalite");
                    next.setDroit("droit");
                    next.setAvatar("avatar");
                    next.setUniversite("universite");
                    next.inserer();
